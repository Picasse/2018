package i.m.c;
public class inmacor extends javax.swing.JFrame
{
    Usuario Us2= new Usuario("Cristian","M",25,155,155);
    public inmacor() 
    {
        initComponents();
    }
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel8.setText("INDICE DE MASA CORPORAL");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      Us2.Setpeso(Float.parseFloat(jTextField5.getText ()));
      Us2.Setestatura(Float.parseFloat(jTextField4.getText ()));
      Us2.Setedad( Integer.parseInt(jTextField3.getText ()));
      jTextField6.setText(String.valueOf( Us2.imc(Us2.getpeso(),Us2.getestatura())));
      Us2.tipoper();
      jTextField7.setText(String.valueOf(Us2.nota));
      Us2.cuidado();
      jTextField8.setText(String.valueOf(Us2.salir));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inmacor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
